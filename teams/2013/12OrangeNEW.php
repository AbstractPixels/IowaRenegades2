            ...
            <ul id="accordion">  
                ...
                <li<?php if($section == 'results'): ?> class=""<?php endif; ?>>  
                    ...
                    <ul id="results">  
                        ...
                        <li><a href="http://www.usssa.com/sports/Tournament3.asp?TournamentID=876001" target="new"><span style="font-size:125%">1st</span></a></li>  
                    </ul>  
                </li>  
            ...
            <div id="contentDiv">
                ...
                <p>
                 <table style="margin-top:-10px;">
                    ...
                    <span style="font-size:33px;color:green;">13-10-1</span></td>
                </tr>
                    <tr>
