...
<div id="container">
    ...
    <ul id="accordion">  
        ...
        <li<?php if($section == '' || $section == 'roster'): ?> class=""<?php endif; ?>>  
            ...
            <ul id="roster">   
                        <li><a href="#player1" class="player1 buttons">Taylor Blackford</a></li>  
                        <li><a href="#player2" class="player2 buttons">Rachel Carstens</a></li> 
                        <li><a href="#player3" class="player3 buttons">Natalie Clark</a></li> 
                        <li><a href="#player4" class="player4 buttons">Rachel McPherson</a></li>
                        <li><a href="#player5" class="player5 buttons">Cassie Shadlow</a></li>
                        <li><a href="#player6" class="player6 buttons">Madison Stogdill</a></li> 
                        <li><a href="#player7" class="player7 buttons">Ashley Tennant</a></li>
                        <li><a href="#player8" class="player8 buttons">Nikki Tennant</a></li> 
                        <li><a href="#player9" class="player9 buttons">Kerigan Torres</a></li>            
            </ul>  
        </li> 
        ...
        <li<?php if($section == 'results'): ?> class=""<?php endif; ?>>  
            ...
            <ul id="results">  
                ...
                <li>Fall Shootout - 8th</li>
                <li>Fall State - <span style="font-size:150%">1st</span></li>
                <li><a href="http://www.usssa.com/sports/Tournament3.asp?TournamentID=863564" target="_new">2012 Heartland Classic
                <br/>College Showcase - 9th</a></li>   
                <li><a href="http://www.usssa.com/sports/Tournament3.asp?TournamentID=901990" target="_new">EISF Winter Indoor - 3rd</a></li>      
            </ul>  
        </li>  
    ...
    <div id="contentDiv">
    	...
    	<div id="teami">
        <div id="teamPic"><img src="../images/teams/18Elite/18Elite-01.jpg" width="320" height="240" alt="18 Elite team picture"></div>
        <p>
         <table style="">
            ...
            <span style="font-size:33px;color:green;">9-14</span></td>
        </tr>
            <tr>
...
<!--        <div id="usssaStatsiFrameWrapper">
                    	<iframe name="usssaStats" id="usssaStats" src="http://www.usssa.com/sports/Team3.asp?TeamID=1843893"  frameborder="0" seamless="seamless" scrolling="no"></iframe>
               		</div><!-- end iframeWrapper-->

        <p style="font-size:14px;"><a href="http://www.usssa.com/sports/Team3.asp?TeamID=1843893" title="Iowa Renegades USSSA page" target="_blank">
